...
__all__ = [
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SMSADeviceId',
    'SWTDeleted', 'SAFTADPCM_11kHzMono', 'SVSFParseSsml',
    'SpeechAudioProperties', 'DISPID_SDKEnumKeys', 'SSFMOpenForRead',
    'SREBookmark', 'DISPID_SVVolume', 'DISPID_SVWaitUntilDone',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechPhraseRules',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPIEngineId',
    'ISpeechPhraseInfoBuilder', 'SRAImport', 'SSFMCreateForWrite',
    ...
    'ISpeechRecognizer', 'DISPID_SPRuleChildren', 'DISPID_SRState',
    'SP_VISEME_6', 'SpeechTokenIdUserLexicon', 'DISPID_SGRId',
    'DISPID_SMSAMMHandle', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFTADPCM_8kHzStereo', 'SpSharedRecoContext',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechPhraseInfo',
    'DISPID_SASCurrentDevicePosition', 'SREPrivate',
    'DISPID_SGRsDynamic', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPRuleEngineConfidence', 'SP_VISEME_21',
    'SAFT11kHz8BitMono', 'SPSHORTCUTPAIRLIST', 'SPSFunction',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPIAudioSizeTime',
    'DISPID_SABufferInfo', 'DISPID_SVSRunningState', 'SpWaveFormatEx',
    'SPINTERFERENCE_NOISE', 'DISPID_SASNonBlockingIO',
    'DISPID_SPCIdToPhone', 'SPGRAMMARSTATE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SVSVisemeId',
    'DISPID_SLPPartOfSpeech', 'DISPID_SFSClose',
    ...
    'DISPID_SRRAlternates', 'ISpeechDataKey', 'SPPS_LMA',
    'DISPID_SRGRecoContext', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'eWORDTYPE_DELETED', 'DISPID_SGRClear', 'DISPID_SOTGetAttribute',
    'SPAUDIOSTATUS', 'DISPID_SASState', 'SPLO_DYNAMIC', 'STCAll',
    'DISPID_SDKCreateKey', 'SRARoot', 'SBONone', 'SVP_3', 'SVP_12',
    'SINoSignal', 'DISPID_SPERequiredConfidence',
    'SpSharedRecognizer', 'SLTUser', 'SpeechRegistryLocalMachineRoot',
    'SAFT24kHz16BitMono', 'SGDisplay', 'SpeechFormatType',
    'DISPID_SPELexicalForm', 'SPAS_RUN', 'DISPID_SGRSTsCount',
    'ISpRecognizer', 'DISPID_SOTDisplayUI',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVStatus',
    'SRTExtendableParse', 'SpeechRecoProfileProperties',
    'SpeechTokenKeyUI', 'UINT_PTR', 'DISPID_SRCEPhraseStart',
    'SPEVENT', 'SPEVENTENUM', 'DISPID_SGRSTNextState', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPRulesItem',
    'DISPID_SVEPhoneme', 'ISpXMLRecoResult', 'IEnumSpObjectTokens',
    'SPFM_CREATE_ALWAYS', 'SRTStandard', 'SAFTNonStandardFormat',
    'eLEXTYPE_RESERVED7', 'SPPS_Function', 'DISPID_SpeechRecoResult',
    'ISpeechGrammarRules', 'DISPID_SOTsItem',
    'SpeechDisplayAttributes', 'SAFT32kHz16BitMono', 'SPAUDIOSTATE',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechGrammarTagWildcard',
    'DISPID_SPRsCount', 'IInternetSecurityManager',
    'DISPID_SOTCEnumerateTokens', 'ISpeechCustomStream',
    'ISequentialStream', 'DISPID_SVEWord', 'SP_VISEME_2',
    'SVSFParseMask', '__MIDL_IWinTypes_0009', 'SpVoice',
    'eLEXTYPE_PRIVATE13', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPRulesCount', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVResume', 'ISpPhraseAlt', 'SFTSREngine',
    'DISPID_SGRsItem', 'SAFT11kHz16BitStereo',
    'DISPID_SPPFirstElement', 'DISPID_SDKOpenKey',
    'SAFT44kHz16BitStereo', 'SSFMOpenReadWrite', 'SRESoundEnd',
    'SITooSlow', 'SPSHORTCUTTYPE', 'SpeechWordPronounceable',
    'DISPID_SBSRead', 'ISpeechRecognizerStatus',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVRate',
    'DISPID_SRSNumberOfActiveRules',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPCT_COMMAND',
    'SREStreamEnd', 'DISPID_SOTGetStorageFileName', 'DISPID_SPRText',
    'SPSHT_EMAIL', 'DISPID_SPRuleNumberOfElements',
    'ISpObjectTokenCategory', 'SDKLCurrentConfig',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGIsPronounceable',
    'SPEVENTSOURCEINFO', 'ISpeechObjectTokens',
    'SDA_Consume_Leading_Spaces', 'ISpeechAudioBufferInfo',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SDKGetlongValue',
    'ISpeechPhraseProperties', 'SSFMCreate', 'SP_VISEME_17',
    '_ISpeechVoiceEvents', 'SpeechWordType', 'SPPHRASE',
    'DISPID_SAVolume', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGSetTextSelection', 'Speech_StreamPos_RealTime',
    'DISPIDSPTSI_ActiveLength', 'ISpStreamFormat',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE20', 'SPLOADOPTIONS',
    'eLEXTYPE_RESERVED8', 'DISPIDSPTSI', 'SP_VISEME_8', 'SPSMF_UPS',
    'ISpeechPhraseRule', 'DISPID_SRCBookmark',
    'DISPID_SRCEStartStream',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SDA_No_Trailing_Space', 'DISPID_SLWsCount', 'SpeechPartOfSpeech',
    ...
    'DISPID_SVSLastBookmarkId', 'ISpeechTextSelectionInformation',
    'SECFEmulateResult', 'SpeechRecognizerState',
    'ISpObjectWithToken', 'SPEI_SOUND_START', 'DISPID_SRRPhraseInfo',
    'DISPID_SPIProperties', 'SAFT22kHz8BitStereo', 'DISPID_SGRSRule',
    'ISpNotifyTranslator', 'SPEI_REQUEST_UI', 'SPRECOSTATE', 'SVP_4',
    'DISPID_SLWPronunciations', 'SAFT16kHz16BitMono', 'SPSModifier',
    'SAFT32kHz16BitStereo', 'ISpeechPhraseProperty',
    'ISpeechAudioFormat', 'ISpeechRecoResultTimes', 'SpMMAudioIn',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE19',
    'DISPID_SABIEventBias', 'SP_VISEME_14', 'SAFTCCITT_ALaw_8kHzMono',
    'SRTEmulated', 'SVPAlert', 'DISPID_SDKSetStringValue',
    'SPAR_Unknown', 'SpeechAudioFormatGUIDWave', 'SpeechAudioVolume',
    'DISPID_SPAsCount', 'SP_VISEME_7',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT32kHz8BitStereo',
    'SDTRule', 'SpResourceManager', 'SAFTGSM610_22kHzMono',
    'SpeechPropertyResourceUsage', 'SPSUnknown', 'SREStateChange',
    'SPEI_HYPOTHESIS', 'ISpeechVoiceStatus', 'SPEI_END_INPUT_STREAM',
    'SDTLexicalForm', 'DISPID_SpeechBaseStream',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPIGetText',
    'SWPUnknownWordPronounceable', 'DISPID_SPAs_NewEnum',
    'SAFT32kHz8BitMono', 'DISPID_SDKGetStringValue', 'ISpVoice',
    'SVSFlagsAsync', 'SVSFParseAutodetect', 'SPWORD',
    'DISPID_SRCEFalseRecognition', 'DISPID_SWFEBlockAlign',
    'SpeechPropertyResponseSpeed', 'SPEI_VOICE_CHANGE', 'SGLexical',
    'DISPID_SVEAudioLevel', 'DISPID_SDKEnumValues', 'SREHypothesis',
    'SGRSTTWord', 'SpeechVoiceSpeakFlags', 'DISPID_SRCResume',
    'DISPID_SRRTLength', 'DISPID_SPCLangId', 'ISpNotifySource',
    'SPGS_EXCLUSIVE', 'DISPID_SPIRule', 'SpeechTokenValueCLSID',
    'SVP_20', 'SPBO_AHEAD', 'DISPID_SVSpeakCompleteEvent',
    'SVSFPersistXML', 'eWORDTYPE_ADDED', 'DISPID_SOTCSetId',
    'SPAUDIOOPTIONS', 'DISPID_SLPsItem', 'DISPID_SpeechMMSysAudio',
    'ISpRecoResult', 'SGRSTTTextBuffer', 'DISPID_SRRTOffsetFromStart',
    'SPRST_INACTIVE_WITH_PURGE', 'SASClosed', 'SAFTADPCM_8kHzMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVIsUISupported',
    'SPBO_PAUSE', 'SRERecognition', 'DISPID_SVSpeakStream',
    'DISPID_SRCEAudioLevel', 'DISPID_SVSInputWordPosition',
    'DISPID_SBSFormat', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVSInputSentenceLength', 'SPEI_ADAPTATION',
    'SGPronounciation', 'ISpeechMMSysAudio', 'SREInterference',
    'DISPID_SLPPhoneIds', 'SGSDisabled', 'SPDKL_DefaultLocation',
    'SRSEDone', 'SPGS_ENABLED', 'SAFT8kHz8BitStereo',
    'ISpRecoGrammar', 'DISPID_SPRules_NewEnum', 'SPAUDIOBUFFERINFO',
    'DISPID_SPRNumberOfElements', 'DISPID_SDKDeleteKey',
    'DISPID_SFSOpen', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechSpecialTransitionType', 'eLEXTYPE_PRIVATE5',
    'SRADefaultToActive', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechAudioBufferInfo', 'SPSVerb',
    'DISPID_SGRSTPropertyName', 'SPEI_START_SR_STREAM', 'SPBO_NONE',
    'ISpeechVoice', 'SPEI_RECO_STATE_CHANGE',
    'SREPropertyStringChange', 'DISPID_SRIsUISupported',
    'SpeechRunState', 'SWPKnownWordPronounceable', 'SPPROPERTYINFO',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRRTimes', 'eLEXTYPE_PRIVATE11',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRAddState',
    'DISPID_SPIAudioStreamPosition', 'SASRun',
    'DISPID_SpeechGrammarRule', 'SDKLLocalMachine', 'DISPID_SVSpeak',
    'ISpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE1', 'SPPS_Noun',
    'DISPID_SOTCDefault', 'DISPID_SOTId', 'SSSPTRelativeToEnd',
    'SpAudioFormat', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseAlternates', 'SpeechCategoryAudioIn',
    'ISpResourceManager', 'SPSMF_SAPI_PROPERTIES', 'SVSFUnusedFlags',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCEPropertyNumberChange',
    'SECFDefault', 'DISPID_SRCVoice', 'ISpeechRecoContext',
    'DISPID_SRGetPropertyNumber', 'STSF_LocalAppData',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRSAddWordTransition',
    'SVEPrivate', 'SPGS_DISABLED',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPRDisplayAttributes', 'DISPID_SMSALineId',
    'STSF_CommonAppData',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEChannels', 'DISPID_SRStatus',
    'DISPID_SPEPronunciation', 'SINoise', 'SpNullPhoneConverter',
    'SRSActiveAlways', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechAudio', 'DISPID_SRGSetWordSequenceData',
    'SGSEnabled', 'ISpRecoContext', 'DISPID_SRAudioInput',
    'DISPID_SPEDisplayText', 'SpeechRecoContextState',
    'SGRSTTEpsilon', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPPValue',
    'ISpeechResourceLoader', 'DISPID_SPCPhoneToId',
    'DISPID_SPEDisplayAttributes', 'DISPID_SLPType', 'SLOStatic',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechVoiceStatus',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLWs_NewEnum',
    'SPBO_TIME_UNITS', 'SAFT16kHz16BitStereo', 'ISpStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCRetainedAudio',
    'SAFTGSM610_44kHzMono', 'DISPID_SVPause', 'SPDATAKEYLOCATION',
    'DISPID_SRCEEndStream', 'SpUnCompressedLexicon', 'SPVPRI_NORMAL',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCCreateResultFromMemory', 'ISpEventSource',
    'DISPID_SPISaveToMemory',
    'DISPID_SpeechGrammarRuleStateTransitions', 'STCInprocServer',
    'SDKLDefaultLocation', 'SPEI_RESERVED3', 'SPINTERFERENCE',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPANumberOfElementsInResult', 'SRTReSent',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechGrammarTagUnlimitedDictation',
    'SPPS_RESERVED4', 'SVSFIsNotXML', 'DISPID_SRGRules',
    'SPSInterjection', 'SPRULESTATE', 'SPFILEMODE',
    'DISPID_SPPConfidence', 'SRAONone', 'DISPID_SVEVoiceChange',
    'DISPID_SRRSpeakAudio', 'DISPID_SRSSupportedLanguages',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_11kHzMono',
    'SSTTWildcard', 'SRSEIsSpeaking', 'SVF_Stressed',
    'DISPID_SWFEExtraData', 'eLEXTYPE_RESERVED9',
    'SAFT12kHz16BitStereo', 'DISPID_SPEs_NewEnum',
    'DISPID_SRRAudioFormat', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPPName', 'DISPID_SGRSTsItem', 'SPPS_Noncontent',
    'SPBOOKMARKOPTIONS', 'DISPID_SWFEBitsPerSample', 'SPSLMA',
    'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE4', 'SREAllEvents',
    'DISPID_SLWWord', 'DISPID_SLPSymbolic', 'Speech_Max_Pron_Length',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechGrammarRules', 'SASStop',
    'SRSInactive', 'DISPID_SRGDictationUnload',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechRegistryUserRoot',
    'SGDSActiveWithAutoPause', 'SpeechGrammarWordType',
    'SP_VISEME_15', 'DISPID_SRCCreateGrammar', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechObjectToken', 'SRSActive',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechRecoContext',
    'DISPID_SGRSTWeight', 'DISPID_SRGCmdLoadFromObject',
    'SpeechDiscardType', 'ISpeechObjectToken', 'SDTProperty',
    'SPSHT_NotOverriden', 'DISPID_SRRAudio', 'DISPID_SVSkip',
    'DISPIDSPRG', 'SGSExclusive', 'ISpMMSysAudio',
    'DISPID_SpeechPhraseReplacements', 'SAFTADPCM_22kHzMono',
    'SPFM_OPEN_READONLY', 'SRAExport', 'SECLowConfidence',
    'DISPID_SRProfile', 'DISPID_SOTCId', 'SpStream',
    'SAFTADPCM_44kHzMono', 'SVSFDefault', 'SREPropertyNumChange',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGId', 'SPPS_Verb',
    'SpeechCategoryAudioOut', '_RemotableHandle', 'eLEXTYPE_PRIVATE7',
    'DISPID_SLPs_NewEnum', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SABufferNotifySize', 'SSTTDictation',
    'DISPID_SpeechPhraseElement', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SOTsCount', 'SpMMAudioOut', 'SAFT16kHz8BitStereo',
    'SAFT24kHz16BitStereo', 'SpeechCategoryPhoneConverters',
    'SPWT_PRONUNCIATION', 'SPEI_SOUND_END', 'SVP_21',
    'SpPhoneConverter', 'SPEI_PHRASE_START', 'SPPS_NotOverriden',
    'ISpeechLexicon', 'eLEXTYPE_PRIVATE6',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechEngineProperties',
    'SpCompressedLexicon', 'SVP_11', 'DISPID_SPIReplacements',
    'DISPID_SVSLastBookmark', 'SPEI_VISEME',
    'DISPID_SLGetGenerationChange', 'ISpDataKey', 'DISPID_SOTDataKey',
    'SPSHT_OTHER', 'SVP_14', 'SpeechEmulationCompareFlags',
    'SPRST_ACTIVE', 'SVESentenceBoundary', 'IInternetSecurityMgrSite',
    'DISPID_SPPsItem', 'SVP_7', 'SGLexicalNoSpecialChars',
    'DISPID_SGRSTRule', 'SVEWordBoundary', 'SpNotifyTranslator',
    'DISPID_SGRName', 'DISPID_SRGCmdSetRuleState', 'SPVPRI_OVER',
    'DISPID_SpeechDataKey', 'SpeechStreamFileMode',
    'DISPID_SVEBookmark', 'SAFT48kHz16BitStereo',
    'SpeechRecognitionType', 'SVEVoiceChange', 'SPEI_RESERVED1',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEI_TTS_PRIVATE',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPAStartElementInResult', 'SVP_1',
    'SPEI_MIN_SR', 'SPCT_SLEEP', 'DISPID_SOTCategory',
    'DISPID_SpeechLexiconProns', 'SECFIgnoreCase',
    'SPEI_WORD_BOUNDARY', 'SAFT48kHz16BitMono', 'SITooFast',
    'SPPS_Modifier', 'SP_VISEME_12', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRCreateRecoContext', 'ISpeechPhraseInfo', 'IEnumString',
    'DISPID_SLWType', 'ISpeechRecoResult2', 'DISPID_SpeechRecognizer',
    'SpeechGrammarState', 'DISPID_SVSLastResult',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPINTERFERENCE_TOOFAST',
    'SpeechCategoryRecognizers', 'DISPID_SADefaultFormat',
    'SPDKL_CurrentConfig', 'SPSNotOverriden', 'SpeechInterference',
    'DISPID_SRCERecognition', 'DISPID_SDKDeleteValue',
    'DISPID_SRRTTickCount', 'DISPID_SLGenerationId',
    'SpeechRuleAttributes', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPAPhraseInfo', 'DISPID_SPPParent', 'SPPHRASERULE',
    'eLEXTYPE_PRIVATE18', 'DISPID_SBSWrite', 'DISPID_SABIBufferSize',
    'DISPID_SASetState', 'SRAInterpreter', 'SVP_6',
    'DISPID_SpeechRecoResult2', 'DISPID_SPEAudioSizeBytes',
    'SITooLoud', 'SECNormalConfidence', 'SpeechBookmarkOptions',
    'DISPID_SGRsAdd', 'DISPID_SAFSetWaveFormatEx', 'ISpAudio',
    'SVSFNLPSpeakPunc', 'DISPID_SPPId', 'ISpSerializeState',
    'ISpRecognizer3', 'SpeechTokenShellFolder',
    'ISpPhoneticAlphabetConverter', 'SPEI_MAX_TTS',
    'SPRECOGNIZERSTATUS', 'SAFTExtendedAudioFormat',
    'SpeechDataKeyLocation', 'SpeechRecoEvents',
    'DISPID_SRGCmdLoadFromFile', 'SpShortcut',
    'DISPID_SVAlertBoundary', 'SRTAutopause',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPRST_INACTIVE', 'ISpPhrase',
    'DISPID_SVAudioOutput', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRAttributes', 'DISPID_SRSAudioStatus',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SDKGetBinaryValue',
    'SPSEMANTICFORMAT', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechPhraseAlternates', 'SDTAlternates',
    'SpeechTokenKeyFiles', 'SAFT12kHz8BitMono', 'SDTAll',
    'SVSFParseSapi', 'SpeechVoicePriority', 'SpeechLoadOption',
    'SPAS_PAUSE', 'SPINTERFERENCE_NONE', 'DISPID_SPIStartTime',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCS_DISABLED',
    'eLEXTYPE_RESERVED6', 'SWPUnknownWordUnpronounceable',
    'DISPID_SGRsCommit', 'SDTDisplayText', 'DISPID_SGRsCommitAndSave',
    'SPAO_NONE', 'SPAR_Medium', 'SRCS_Enabled', 'DISPID_SGRs_NewEnum',
    'SRAORetainAudio', 'DISPID_SRGReset', 'SPPS_RESERVED2',
    'STCRemoteServer', 'SPPS_Interjection', 'ISpeechPhraseRules',
    'SPLEXICONTYPE', 'SRATopLevel', '_SPAUDIOSTATE',
    'ISpeechPhraseElement', 'SPXMLRESULTOPTIONS', 'DISPID_SAFGuid',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRERecoOtherContext', 'SVP_17',
    ...
    'DISPID_SABIMinNotification', 'SPXRO_SML',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPIRetainedSizeBytes', 'SPINTERFERENCE_TOOSLOW',
    'SPPHRASEREPLACEMENT', 'DISPID_SVGetVoices', 'SBOPause',
    'ISpeechPhraseElements', 'SPCT_SUB_COMMAND', 'SREStreamStart',
    'SPWORDPRONOUNCEABLE', 'SPSNoun', 'DISPID_SPPs_NewEnum',
    'SPEI_INTERFERENCE', 'ISpeechAudioStatus',
    'DISPID_SpeechObjectTokenCategory', 'SAFTADPCM_22kHzStereo',
    'SpStreamFormatConverter', 'DISPID_SRDisplayUI', 'SVEAudioLevel',
    'DISPID_SRIsShared', 'DISPID_SRCRequestedUIType', 'SP_VISEME_3',
    'SpeechRetainedAudioOptions', 'SPSSuppressWord', 'SPFM_NUM_MODES',
    'ISpNotifySink', 'SAFT12kHz16BitMono', 'SITooQuiet',
    'ISpObjectToken', 'SpInprocRecognizer',
    'DISPID_SGRSAddRuleTransition', 'SP_VISEME_20',
    'ISpeechPhraseReplacement', 'SASPause', 'STCInprocHandler',
    'SDKLCurrentUser', 'SPGRAMMARWORDTYPE', 'SREFalseRecognition',
    'SPWT_DISPLAY', 'DISPID_SRCEventInterests', 'DISPID_SMSGetData',
    'SPPHRASEELEMENT', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSAddSpecialTransition', 'SpFileStream',
    'SPSERIALIZEDRESULT', 'SAFT16kHz8BitMono',
    'SpeechGrammarRuleStateTransitionType', 'SpeechLexiconType',
    'SPRECOCONTEXTSTATUS', 'SGRSTTRule', 'DISPID_SPEEngineConfidence',
    'SP_VISEME_9', 'ISpRecoContext2', 'DISPID_SpeechRecognizerStatus',
    'SREAudioLevel', 'SpeechMicTraining', 'DISPID_SPEsCount',
    'DISPID_SpeechFileStream', 'SPRULE', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechPhraseElements', 'SPWAVEFORMATTYPE',
    'SGRSTTWildcard', 'DISPID_SRCERecognitionForOtherContext',
    'SP_VISEME_18', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRRSaveToMemory', 'tagSTATSTG',
    'SpeechDictationTopicSpelling', 'SPEI_TTS_AUDIO_LEVEL',
    'SpPhoneticAlphabetConverter', 'ISpGrammarBuilder', 'SVSFNLPMask',
    'SpeechTokenKeyAttributes', 'SpeechVisemeFeature', 'SVP_10',
    'SAFT24kHz8BitStereo', 'SPEI_START_INPUT_STREAM',
    'SAFT44kHz8BitMono', 'ISpeechMemoryStream',
    'ISpPhoneticAlphabetSelection', 'SSSPTRelativeToStart',
    'SVF_None', 'SVEPhoneme', 'ISpStreamFormatConverter',
    'SPWT_LEXICAL', 'DISPID_SGRInitialState', 'DISPID_SRCESoundStart',
    'SPEI_END_SR_STREAM', 'ISpeechLexiconPronunciation',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPRuleFirstElement',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechAudio', 'SP_VISEME_0',
    'SGDSInactive', 'DISPID_SAFType', 'DISPID_SPACommit',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechMemoryStream', 'DISPID_SPARecoResult',
    'eLEXTYPE_PRIVATE12', 'SPPARTOFSPEECH', 'SpeechRuleState',
    'SVSFIsXML', 'DISPID_SPRuleParent', 'SRADynamic',
    'SAFT8kHz16BitStereo', 'DISPID_SRCEInterference', 'SVP_9',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_RESERVED4',
    'DISPID_SVPriority', 'SpInProcRecoContext', 'SpLexicon',
    'ISpeechGrammarRuleState', 'SpeechAudioState',
    'SAFT44kHz16BitMono', 'DISPID_SVEStreamStart', 'SPWORDLIST',
    'DISPID_SpeechLexiconWords', 'SPRST_NUM_STATES',
    'DISPID_SVESentenceBoundary', 'SPEI_SR_PRIVATE', 'SAFTDefault',
    'DISPID_SVEViseme', 'WAVEFORMATEX', 'SPEI_RECOGNITION',
    'DISPID_SGRSTransitions', 'DISPID_SAEventHandle', 'SVP_2',
    'DISPIDSPTSI_SelectionOffset', 'SPEI_RESERVED6', 'SpMMAudioEnum',
    'SECFNoSpecialChars', 'DISPID_SRSCurrentStreamNumber',
    'SRTSMLTimeout', 'SGDSActiveUserDelimited',
    'DISPID_SpeechPhoneConverter', 'SVP_13', 'SAFTNoAssignedFormat',
    'DISPID_SVAudioOutputStream', 'DISPID_SCSBaseStream',
    'DISPID_SPEAudioStreamOffset', 'ISpRecognizer2',
    'SECFIgnoreKanaType', 'SPWORDTYPE', 'SpObjectToken',
    'SPLO_STATIC', 'SPAR_Low', 'ISpeechXMLRecoResult',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_VENDORLEXICON',
    'SPVPRI_ALERT', 'SAFT24kHz8BitMono', 'DISPID_SGRAddResource',
    'DISPID_SVGetProfiles', 'DISPID_SPILanguageId', 'SVEAllEvents',
    'SpPhraseInfoBuilder', 'DISPID_SGRsCount',
    'DISPID_SPIEnginePrivateData', 'SAFTGSM610_8kHzMono',
    'DISPID_SRGetFormat', 'DISPID_SRCPause', 'SPBINARYGRAMMAR',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVEEnginePrivate',
    'SPEI_FALSE_RECOGNITION', 'IStream', 'SpeechAddRemoveWord',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEHypothesis', 'SRESoundStart', 'eLEXTYPE_RESERVED10',
    'SVF_Emphasis', 'SPSHT_Unknown', 'DISPID_SPPsCount',
    'SECFIgnoreWidth', 'SPCS_ENABLED', 'SPSERIALIZEDPHRASE',
    'DISPID_SRGState', 'SREPhraseStart', 'DISPID_SRGCommit',
    'SpCustomStream', 'ISpProperties', 'SP_VISEME_10', 'SPAR_High',
    'SLTApp', 'DISPID_SRRGetXMLResult', 'DISPID_SpeechLexiconWord',
    'SREAdaptation', 'DISPID_SPRsItem', 'Speech_Max_Word_Length',
    'SAFTCCITT_uLaw_11kHzStereo', 'SGRSTTDictation',
    'SpeechCategoryVoices', 'SLODynamic', 'DISPID_SVDisplayUI',
    'DISPID_SRRDiscardResultInfo', 'SpeechPropertyAdaptationOn',
    'DISPID_SRSClsidEngine', 'SPAO_RETAIN_AUDIO',
    '_ISpeechRecoContextEvents', 'ISpEventSink', 'ISpeechFileStream',
    'DISPID_SPIElements', 'SPFM_CREATE', 'DISPID_SLWsItem',
    'DISPID_SOTCreateInstance', 'SPVOICESTATUS',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVP_15', 'SAFTText',
    'SAFT12kHz8BitStereo', 'SpeechAudioFormatGUIDText',
    'SPWF_SRENGINE', 'SWTAdded', 'DISPID_SRGetPropertyString',
    'DISPID_SRGetRecognizers', 'LONG_PTR', 'DISPID_SRCState',
    ...
    'SpeechAllElements', 'SPCT_SUB_DICTATION', 'SPSTREAMFORMATTYPE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPXRO_Alternates_SML', 'SECHighConfidence',
    'SAFT11kHz8BitStereo', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechPhraseProperty', 'SVP_16',
    'SpeechPropertyNormalConfidenceThreshold', 'SPRECORESULTTIMES',
    'SP_VISEME_16', 'SPEI_UNDEFINED', 'DISPID_SLRemovePronunciation',
    'DISPID_SVVoice', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechLexiconWord', 'ISpeechPhraseAlternate', 'SPEI_RESERVED2',
    'SVPOver', 'SRSInactiveWithPurge', 'SAFT22kHz16BitStereo',
    'SVPNormal', 'DISPID_SVEStreamEnd', 'SDTReplacement',
    'SpeechCategoryRecoProfiles', 'SPPS_RESERVED3',
    'DISPID_SLPsCount', 'SVP_5', 'DISPID_SPAsItem',
    'DISPID_SASFreeBufferSpace', 'SPRS_ACTIVE',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRRecognizer',
    'SPCT_DICTATION', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SLWLangId', 'SpObjectTokenCategory', 'STSF_FlagCreate',
    'DISPID_SRCEPropertyStringChange', 'SAFT48kHz8BitStereo',
    'SPRS_INACTIVE', 'SVP_8', 'SPWF_INPUT', 'SDA_One_Trailing_Space',
    'DISPID_SPEsItem', 'SDTPronunciation', 'eLEXTYPE_PRIVATE14',
    'SPAS_CLOSED', 'ISpeechRecoGrammar', 'SAFT8kHz8BitMono',
    'DISPID_SRRRecoContext', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SLGetPronunciations', 'DISPID_SRGDictationLoad',
    'SP_VISEME_11', 'ISpeechBaseStream', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_PRIVATE15',
    'SVSFVoiceMask', 'SINone', 'SPTEXTSELECTIONINFO',
    'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRSetTextFeedback', 'SVP_19',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_19', 'SVSFPurgeBeforeSpeak',
    'DISPID_SGRSTType', 'DISPID_SAStatus', 'SPCATEGORYTYPE',
    'SpeechVisemeType', 'SP_VISEME_13', 'eLEXTYPE_APP',
    'STCLocalServer', 'DISPID_SRCEBookmark', 'SFTInput',
    'DISPID_SpeechVoiceEvent', 'SAFTADPCM_11kHzStereo',
    'ISpeechWaveFormatEx', 'ISpLexicon', 'DISPID_SVGetAudioOutputs',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechLexiconWords',
    ...
    'SVSFIsFilename', 'SVEStartInputStream',
    'DISPID_SVEventInterests', 'SP_VISEME_4', 'SAFT22kHz16BitMono',
    'SPSEMANTICERRORINFO', 'SPAS_STOP', 'DISPID_SLPLangId',
    'DISPID_SRGDictationSetState', 'DISPID_SMSSetData', 'SP_VISEME_1',
    'SVP_18', 'SpeechGrammarTagDictation', 'ISpRecoCategory',
    'SPVISEMES', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechPhraseReplacements', 'DISPID_SpeechLexicon',
    'DISPID_SRCRecognizer', 'SpTextSelectionInformation',
    'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_USER',
    'DISPID_SRCEEnginePrivate', 'SP_VISEME_5', 'DISPID_SBSSeek',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechEngineConfidence',
    'DISPID_SOTRemove', 'ISpShortcut', 'DISPID_SPIAudioSizeBytes',
    'ISpPhoneConverter', 'ISpeechRecoResult', 'DISPID_SOTSetId',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVEEndInputStream', 'SRERequestUI',
    'SpeechAudioFormatType', 'ISpeechGrammarRuleStateTransition',
    'ISpRecoGrammar2', 'DISPID_SGRSTPropertyValue', 'SPPS_RESERVED1',
    'SAFTADPCM_44kHzStereo', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT48kHz8BitMono', 'SPWORDPRONUNCIATION', 'SRCS_Disabled',
    'SVP_0', 'SPEI_SR_BOOKMARK', 'DISPID_SVSCurrentStreamNumber',
    'SPCONTEXTSTATE', 'DISPID_SpeechPhraseRule',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechVoice',
    'DISPID_SOTIsUISupported', 'SPDKL_LocalMachine',
    'DISPID_SRCEAdaptation', 'SAFT11kHz16BitMono',
    'SAFT22kHz8BitMono', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCERequestUI', 'SGDSActive', 'SPEI_PHONEME',
    'SpeechTokenContext', 'eLEXTYPE_PRIVATE8', 'eLEXTYPE_PRIVATE2',
    'SPPS_Unknown', 'DISPID_SPRFirstElement', 'tagSPPROPERTYINFO',
    'DISPID_SPPChildren', 'SDTAudio', 'DISPID_SPRuleConfidence',
    'DISPID_SWFEFormatTag', 'SVEBookmark', 'SVEViseme',
    'SPPHRASEPROPERTY', 'Speech_Default_Weight',
    'DISPID_SGRsFindRule', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEI_MAX_SR', 'DISPID_SGRSTText', 'DISPIDSPTSI_SelectionLength',
    'STSF_AppData', 'eLEXTYPE_PRIVATE3', 'DISPID_SRRTStreamTime',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechObjectTokens',
    'SAFT44kHz8BitStereo', 'SpeechUserTraining', 'SPSHORTCUTPAIR'
]

_check_version('1.2.0', 1662606344.702192)
